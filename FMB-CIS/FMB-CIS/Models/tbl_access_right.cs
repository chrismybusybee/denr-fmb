namespace FMB_CIS.Models
{
    public class tbl_access_right
    {
        ...
        public int parent_id { get; set; } // Note: A page can be parent to a page, same with module, and functionality, no restrictions as it is mostly for organization purpose
