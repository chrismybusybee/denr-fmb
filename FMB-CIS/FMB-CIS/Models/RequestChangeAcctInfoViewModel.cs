...
{
    public class RequestChangeAcctInfoViewModel
    {
        ...
        public string? region { get; set; } //FOR VIEW
        public string? province { get; set; } //FOR VIEW
        public string? city { get; set; } //FOR VIEW
        public string? brgy { get; set; } //FOR VIEW
        public string? street_address { get; set; }
        public string? email { get; set; }
        public int? tbl_user_types_id { get; set; }
        public string? userType { get; set; } //FOR VIEW
        ...
        public string? status { get; set; } //FOR VIEW
