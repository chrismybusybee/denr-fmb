    ...
    public class OfficeManagementController : Controller
    {
        ...
        public IActionResult BrandListPartialView()
        {
            ...
            if (usrRoleID == 14) // Super Admin
            {
                ...
                return PartialView("~/Views/OfficeManagement/Brand/Partial/BrandListPartial.cshtml", model);
            }
            else
            {
                return RedirectToAction("Index", "Dashboard");
        ...
        public IActionResult BrandCreateModal()
        {
            ...
            if (usrRoleID == 14) // Super Admin
            {
                ...
                return PartialView("~/Views/OfficeManagement/Brand/Modal/BrandCreateModal.cshtml", model);
            }
            else
            {
                return RedirectToAction("Index", "Dashboard");
        ...
        public IActionResult BrandUpdateModal(int id)
        {
            ...
            if (usrRoleID == 14) // Super Admin
            {
                ...
                return PartialView("~/Views/OfficeManagement/Brand/Modal/BrandUpdateModal.cshtml", model);
            }
            else
            {
                return RedirectToAction("Index", "Dashboard");
        ...
        public IActionResult BrandDeleteModal(int id)
        {
            ...
            if (usrRoleID == 14) // Super Admin
            {
                ...
                return PartialView("~/Views/OfficeManagement/OfficeType/Modal/BrandDeleteModal.cshtml", model);
            }
            else
            {
                return RedirectToAction("Index", "Dashboard");
        ...
        [HttpPut("OfficeManagement/BrandUpdate/{id:int}")]
        ...
        [HttpDelete("OfficeManagement/BrandDelete/{id:int}")]
